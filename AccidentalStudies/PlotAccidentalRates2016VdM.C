////////////////////////////////////////////////////////////////////
//
//  PlotAccidentalRates2016VdM -- a simple modification of
//   PlotAccidentalRates for the 2016 VdM scan fills
//    Paul Lujan, May 25 2016
//
////////////////////////////////////////////////////////////////////
...
void PlotAccidentalRates2016VdM(void) {
  // style from PLTU
  ...
  FILE *rfile = fopen("CombinedRates_4954_VdMCombined.txt", "r");
  if (rfile == NULL) {
  ...
  g2->Draw("AP");
  g2->SetTitle("Accidental rate vs. online luminosity, all scans, fill 4954");
  ...
  c2->Print("AccidentalRate_4954_VdM2016_AllScans.png");
}
