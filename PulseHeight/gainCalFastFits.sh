...
for l in ${list2015[*]}
do
 ./GainCalFastFits /localdata/2015/CALIB/GainCal/$l
done
...
for l in ${list2016[*]}
do
 ./GainCalFastFits /localdata/2016/CALIB/GainCal/$l
done
...
for l in ${list2017[*]}
do
 ./GainCalFastFits /localdata/2017/CALIB/GainCal/$l
done
...
for l in ${list2018[*]}
do
 ./GainCalFastFits /localdata/2018/CALIB/GainCal/$l
done
