...
alignment_file2015=(Trans_Alignment_4208.dat Trans_Alignment_4256.dat Trans_Alignment_4381.dat Trans_Alignment_4449.dat Trans_Alignment_4449.dat Trans_Alignment_4449.dat Trans_Alignment_4565.dat)

for index in ${!slink2015[*]}; 
do
  ./ROCEfficiency /localdata/2015/SLINK/${slink2015[$index]} FitResultErrorVCal80800_2/${gaincalfile2015[$index]}  ${fill2015[$index]} ALIGNMENT/${alignment_file2015[$index]}
...
alignment_file2016=(Trans_Alignment_4879.dat Trans_Alignment_4895.dat Trans_Alignment_4895.dat Trans_Alignment_4895.dat Trans_Alignment_4895.dat Trans_Alignment_4895.dat Trans_Alignment_4895.dat Trans_Alignment_4895.dat Trans_Alignment_4895.dat Trans_Alignment_4895.dat Trans_Alignment_4895.dat Trans_Alignment_4895.dat)


for index in ${!slink2016[*]};
do
  ./ROCEfficiency /localdata/2016/SLINK/${slink2016[$index]} FitResultErrorVCal80800_2/${gaincalfile2016[$index]} ${fill2016[$index]} ALIGNMENT/${alignment_file2016[$index]}            
...
alignment_file2017=(Trans_Alignment_2017MagnetOn_Prelim.dat Trans_Alignment_2017MagnetOn_Prelim.dat Trans_Alignment_2017MagnetOn_Prelim.dat Trans_Alignment_2017MagnetOn_Prelim.dat Trans_Alignment_2017MagnetOn_Prelim.dat Trans_Alignment_2017MagnetOn_Prelim.dat Trans_Alignment_2017MagnetOn_Prelim.dat Trans_Alignment_2017MagnetOn_Prelim.dat Trans_Alignment_2017MagnetOn_Prelim.dat Trans_Alignment_2017MagnetOn_Prelim.dat Trans_Alignment_2017MagnetOn_Prelim.dat Trans_Alignment_2017MagnetOn_Prelim.dat)

for index in ${!slink2017[*]};
do
  ./ROCEfficiency /localdata/2017/SLINK/${slink2017[$index]} FitResultErrorVCal80800_2/${gaincalfile2017[$index]} ${fill2017[$index]} ALIGNMENT/${alignment_file2017[$index]} 
