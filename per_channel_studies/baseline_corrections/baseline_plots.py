#Project8: Starting from one or more  txt file(s), this script will collect the data for baseline correction values in PLT channels, gathering data for Pixel FED, FastOR FED-xy for every channel 0 to 15.
#Beg. date: 24/10/2017
...
#(and k should be their sum apart from "rounding")
