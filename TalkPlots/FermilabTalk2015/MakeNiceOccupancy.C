void DrawHeader(void) {
  ...
  TText *t3 = new TText(0.83, 0.92, "Fill 3851");
  t3->SetNDC(true);
  t3->SetX(0.83);
  t3->SetY(0.92);
  t3->SetTextAlign(31);
...
void MakeNiceOccupancy(void) {
  ...
  TFile *f = new TFile("histo_occupancy.root");
  TH2F *h1 = (TH2F*)f->Get("Occupancy Ch07 ROC0;1");
  TH2F *h2 = (TH2F*)f->Get("Occupancy Ch07 ROC1;1");
  TH2F *h3 = (TH2F*)f->Get("Occupancy Ch07 ROC2;1");
  ...
  c1->Print("occupancies3851.png");
  c1->Print("occupancies3851.pdf");
  c1->Print("occupancies3851.eps");
}
