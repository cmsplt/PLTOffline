// @(#)root/eve:$Id: TEveVSDStructs.h 48580 2013-02-14 22:24:28Z rdm $
...
#using TEveRecTrack = TEveRecTrack<Float_t>;
#using TEveRecTrackF = TEveRecTrack<Float_t>;
#using TEveRecTrackD = TEveRecTrack<Double_t>;
